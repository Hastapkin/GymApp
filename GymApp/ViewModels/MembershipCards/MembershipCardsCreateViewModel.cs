...
namespace GymApp.ViewModels.Membership
{
    public class MembershipCardsCreateViewModel : INotifyPropertyChanged
    {
        ...
        public event Action? MembershipCardCreated;
        ...
        private async void Save(object? parameter)
        {
            try
            {
                ...
                await _dbContext.CreateMembershipCardAsync(membershipCard);
                MembershipCardCreated?.Invoke();
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"Error creating membership card: {ex.Message}");
            }
        }
