...
-- View hiển thị thông tin thành viên và thẻ tập
...
FROM Members m
LEFT JOIN MembershipCards mc ON m.Id = mc.MemberId
...
SELECT 'Database đã được tạo thành công!' as MESSAGE FROM dual;
...
SELECT 'Kết nối database:' as INFO FROM dual;
SELECT 'Host: localhost:1521/FREE' as CONNECTION_INFO FROM dual;
SELECT 'User: C##GymApp' as USER_INFO FROM dual;
SELECT 'Password: a123' as PASSWORD_INFO FROM dual;
